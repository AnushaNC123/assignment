...
<center>
    ...
    <form method="post">
        <table border="0">
            ...
            <tr>
                <td>Degree Percent</td><td><input type="number" name="deg"  placeholder="Percentage in degree" required/></td>
            </tr>
            <tr>
                <td>Hobbies</td><td><input type="checkbox" name="hobby"  value="sports"/>Sports
